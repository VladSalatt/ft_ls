...
t_file					*ft_struct_filenames(t_file **head, const char **av, \
const char *path, t_flags *flags);
void					ft_recursion_init(t_file *head, const char **av, \
t_flags *flags);
...
void					ft_whats_tools(t_file **new, mode_t mode, \
uid_t uid, gid_t gid);
...
void					ft_recursion_penetration(const char *path, \
t_flags *flags, int path_flag);
void					ft_print_path(const char *path);
t_file					*ft_get_rootnames(t_file **head, const char *path, \
t_flags *flags);
int						ft_can_add_hidden_file(const char *str, t_flags *flags);
t_file					*ft_new_list(t_file *new, const char *name, \
const char *path, t_flags *flags);
int						ft_whats_specific(const char *str, t_file **new, \
t_flags *flags);
